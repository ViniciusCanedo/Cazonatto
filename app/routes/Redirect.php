...
class Redirect
{
    ...
    {
        $_SESSION['redirect'] = [
            'actual' => $route->getUriInstance()->getUri(),
            'previous' => '',
    ...
    private static function canChangeRedirect(Route $route){
        return $route->getUriInstance()->getUri() !== $_SESSION['redirect']['actual'] && $route->request === $_SESSION['redirect']['request'] ||
                $route->getUriInstance()->getUri() === $_SESSION['redirect']['actual'] && $route->request !== $_SESSION['redirect']['request'];
    }
